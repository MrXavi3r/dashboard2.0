  ...
  const toggleMenuState = (menuState) => {
    switch (menuState) {
        case appsMenuOpen:
            ...
            break;
        case basicUiMenuOpen:
            setBasicUiMenuOpen(true)
            break;
        case formElementsMenuOpen:
            setFormElementsMenuOpen(true)
            break;
        case tablesMenuOpen:
            setTablesMenuOpen(true)
            break;
        case iconsMenuOpen:
            setIconsMenuOpen(true)
            break;
        case chartsMenuOpen:
            setChartsMenuOpen(true)
            break;
        case userPagesMenuOpen:
            setUserPagesMenuOpen(true)
            break;
        case errorPagesMenuOpen:
            setErrorPagesMenuOpen(true)
            break;
        ...
        <ul className="nav position-fixed">
          ...
          >
            ...
            >
              ...
              <span className="menu-title text-light">Tables</span>
              <i className="menu-arrow"></i>
            </div>
          ...
          >
            ...
            >
              ...
              <span className="menu-title text-light">Charts</span>
              <i className="menu-arrow"></i>
            </div>
          ...
          >
            ...
            >
              ...
              <span className="menu-title text-light">Icons</span>
              <i className="menu-arrow"></i>
            </div>
