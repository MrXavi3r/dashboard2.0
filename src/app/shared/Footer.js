      ...
      <footer className="footer bg-light">
        <div className="container-fluid">
          <div className="d-sm-flex justify-content-center justify-content-sm-between py-2 w-100">
            <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright @<a href="https://mrXavi3r.github.io/portfolio-site" target="_blank" rel="noopener noreferrer">Xavier </a> 2021</span>
