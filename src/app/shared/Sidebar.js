      ...
      <nav className="sidebar sidebar-offcanvas bg-info" id="sidebar">
        ...
        <ul className="nav position-fixed">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>Xavier Ritch</Trans></h5>
                  <span className="text-light"><Trans>Administrator</Trans></span>
                </div>
              </div>
              <Dropdown alignRight>
          ...
          <li className="nav-item nav-category">
            <span className="nav-link text-dark"><Trans>Navigation</Trans></span>
          </li>
          <li className={ this.isPathActive('/dashboard') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/dashboard">
              <span className="menu-icon bg-dark"><i className="mdi mdi-speedometer"></i></span>
          ...
          <li className={ this.isPathActive('/basic-ui') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Basic UI Elements</Trans></span>
          ...
          <li className={ this.isPathActive('/form-elements') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.formElementsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('formElementsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Form Elements</Trans></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.formElementsMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item text-light"> <Link className={ this.isPathActive('/form-elements/basic-elements') ? 'nav-link active' : 'nav-link' } to="/form-elements/basic-elements"><Trans>Basic Elements</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/tables') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.tablesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('tablesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Tables</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className={ this.isPathActive('/charts') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.chartsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('chartsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Charts</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className={ this.isPathActive('/icons') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.iconsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('iconsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Icons</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className={ this.isPathActive('/user-pages') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.userPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('userPagesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>User Pages</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className="nav-item nav-category">
            <span className="nav-link text-dark"><Trans>More</Trans></span>
          </li>
          <li className={ this.isPathActive('/error-pages') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.errorPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('errorPagesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title text-light"><Trans>Error Pages</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className="nav-item menu-items">
            <a className="nav-link" href="http://bootstrapdash.com/demo/corona-react-free/documentation/documentation.html" rel="noopener noreferrer" target="_blank">
              ...
              <span className="menu-title text-light"><Trans>Documentation</Trans></span>
            </a>
          </li>
        </ul>
      </nav>
